...
if (sessionStorage.getItem("portfolio-auth") === "ok") unlock();
...
function renderWorks() {
  ...
  function update() {
    ...
    if (category !== "all") items = items.filter(w => w.category.includes(category));
    items.sort((a,b) => order === "new" ? b.year - a.year : a.year - b.year);
